            ...
            {ServiceEntries[0].services.map((service, i) => {
                ...
                <div key={i}>
                    ...
                    <p className='app-form'>
                        ...
                        <input type='text' name='serviceMileage' placeholder='SMileage' value={service.service_mileage}/>
                    </p>
                    ...
                    <p className='app-form'>
                        ...
                        <input type='text' name='serviceBy' placeholder='SBy' value={service.service_by}/>
                    </p>       

                    <p className='app-form'>
                        <label className='Add-Vehicle-Label'>Service Receipt</label>
                        <input type='text' name='serviceReceipt' placeholder={null} value={service.service_receipt}/>
                    </p>
                </div>
                )
            })}
